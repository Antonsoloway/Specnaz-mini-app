...
(() => {
  ...
  function renderActiveTeamsPage() {
    ...
    panel.hidden = false;
    panel.innerHTML = `<section class="active-teams-page-v0559"><button type="button" class="royal-back-button" data-royal-back="1">← Назад</button><div class="active-teams-head-v0559"><h2>Команды принимающие участие в спецназе</h2><p>Команды, участвующие в спецназе и(или) регулярно выкладывающие скрины в базе спецназа.</p><span class="active-teams-count-v0559">${list.length} команд</span></div><div class="active-teams-controls-v0559"><div class="royal-game-filter active-teams-filter-v0559" role="group" aria-label="Фильтр команд спецназа по игре"><button type="button" class="royal-game-filter-btn is-active" data-game-filter="all" aria-pressed="true">Все</button><button type="button" class="royal-game-filter-btn" data-game-filter="rm" aria-pressed="false">РМ</button><button type="button" class="royal-game-filter-btn" data-game-filter="rk" aria-pressed="false">РК</button></div><label class="search-box active-teams-search-box-v0559"><span>🔎</span><input id="activeTeamSearch" type="search" placeholder="Название команды или игра…" autocomplete="off" autocapitalize="none" spellcheck="false"></label></div><div class="active-teams-list-v0559 teams-list"></div></section>`;
