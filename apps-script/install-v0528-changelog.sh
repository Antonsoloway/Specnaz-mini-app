...
BACKUP=~/table-chp-backups/table-chp-before-v0528-changelog-$(date +%Y%m%d-%H%M%S).tgz
tar -czf "$BACKUP" .
...
grep -q "app-v0528.html" 22_MINIAPP_BOT_APP_MENU.js
grep -q "MINIAPP_BOT_APP_MENU_VERSION = '1.0.25'" 22_MINIAPP_BOT_APP_MENU.js

echo "MENU_V0528_OK"
clasp status
clasp push

echo "V0528_CHANGELOG_PUSH_OK"
