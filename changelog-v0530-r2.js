/* Royal CRM Mini App — changelog hotfix for v0.5.30 */
(() => {
  ...
  // v0.5.29 installs a document-capture handler that stops propagation.
  // Window capture runs earlier and guarantees that v0.5.30 opens its own history.
