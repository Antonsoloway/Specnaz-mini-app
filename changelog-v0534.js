/* Royal CRM Mini App — changelog v0.5.34 */
(() => {
  ...
  const RELEASES = [
    {
      version: '0.5.34',
      title: 'Достижения и админ в профиле',
      changes: [
        'На подробной странице администратора плашка «Админ» теперь красная, как и в списках участников.',
        'Плашка «Админ» в профиле кликабельна и открывает актуальный список всех администраторов чата.',
        'Над большой иконкой ранга добавлен декоративный золотой заголовок «Достижения».',
        'В списках исправлено расположение: плашка «Админ» находится строго над плашкой ранга, а общий блок ачивок остаётся справа от имени.',
        'Сохранена строка «Помощь в разработке, тесты: @sfinks_spb».'
      ]
    },
    {
      version: '0.5.33',
    ...
    ...previous.filter(item => !['0.5.34','0.5.33','0.5.32','0.5.31','0.5.30'].includes(String(item?.version || '')))
  ];
