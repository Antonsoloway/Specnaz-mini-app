/* Royal CRM Mini App — changelog v0.5.51 */
(() => {
  ...
  const RELEASES = [{
    version:'0.5.51',
    title:'Исправление названий РК',
    changes:[
      'Исправлен поиск команды HEPBbl B HOPME в Royal Kingdom по запросу «нервы в норме».',
      'Исправлен поиск команды Mbl Pycckue по запросу «мы русские».',
      'Подтверждённые русские варианты добавляются и в общий поиск, и в поиск при активном фильтре РК.'
    ]
  }, ...previous];
