/* Royal CRM Mini App — changelog v0.5.57 */
(() => {
  ...
  const RELEASES = [{
    version:'0.5.57',
    title:'Все страницы открываются сверху',
    changes:[
      'Исправлена навигация: при открытии команды, участника, раздела, истории изменений и других внутренних экранов позиция прокрутки всегда сбрасывается в начало страницы.',
      'Переход назад также открывает восстановленный экран сверху вместо случайного возврата в середину или низ.',
      'Отключено автоматическое восстановление scroll-позиции браузером для внутренних переходов Mini App.'
    ]
  }, ...previous];
