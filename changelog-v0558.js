/* Royal CRM Mini App — changelog v0.5.58 */
(() => {
  ...
  const RELEASES = [{
    version:'0.5.58',
    title:'Вперёд — вверх, назад — на место',
    changes:[
      'Новые страницы по-прежнему всегда открываются с самого верха.',
      'Кнопка «Назад» снова возвращает список на ту же позицию прокрутки, где пользователь остановился перед переходом.',
      'Убрано принудительное обнуление scroll-позиции при Back-навигации и Telegram BackButton.'
    ]
  }, ...previous];
