...
(() => {
  ...
  const RELEASES = [{
    ...
    changes:[
      ...
      'У участников без @username на месте ссылки Telegram появилась кнопка «Связаться», открывающая профиль по raw Telegram ID через tg://user?id=…; существующие @username продолжают работать как раньше.',
