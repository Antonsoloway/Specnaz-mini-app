...
(() => {
  ...
  const RELEASES = [{
    ...
    changes:[
      ...
      'Значок крота переведён на отдельный чистый встроенный asset без серой нижней части и центрируется внутри кнопки.',
      ...
      'Нажатие на значок на странице команды открывает отдельную страницу «Команды принимающие участие в спецназе» со всеми активными командами.'
    ]
  }, ...previous];
