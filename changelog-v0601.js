  ...
  const SECTIONS = [
    {
      ...
      changes:[
        ...
        'Учтено состояние Apps Script, когда скрытый реестр «Аватары» сохраняет последний известный file_id, но очередная проверка Telegram возвращает ERROR; такое состояние больше не должно блокировать попытку восстановить ранее сохранённое фото.',
