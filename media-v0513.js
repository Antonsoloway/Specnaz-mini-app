/* Royal CRM Mini App — observer-free media loader v0.5.13 */
...
if (typeof renderTeamDetail === 'function') {
  const mediaNativeRenderTeamDetail = renderTeamDetail;
  renderTeamDetail = function(teamRef) {
    const result = mediaNativeRenderTeamDetail(teamRef);
    Promise.resolve().then(() => mediaLoadTeamPhoto());
    return result;
  };
}

window.__ROYAL_MEDIA_VERSION__ = '0.5.13';
